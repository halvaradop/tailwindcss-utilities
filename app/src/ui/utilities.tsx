    ...
    return (
        <section className="">
            ...
            <section className="mx-10 border-x border-solid border-border base:mx-16">
                ...
                <div>
                    <div className="grid text-primary article:border-t article:border-solid article:border-border article:a:p:text-muted lg:grid-cols-2 lg:article:border-r lg:article:last:border-r-0">
                        <article>
