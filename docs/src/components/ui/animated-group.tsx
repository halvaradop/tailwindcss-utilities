...
import { PresetType } from "@/@types/types"
import { AnimatedGroupProps } from "@/@types/props"
...
export const AnimatedGroup = ({ children, className, variants, preset }: AnimatedGroupProps) => {
